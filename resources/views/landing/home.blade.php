...
@section('content')
    ...
    <!-- section produk -->
    <div class=" p-5 mt-10  bg-surface-700" id="produk">
    ...
    <!-- section About Us -->
    <div class="mt-28" id="tentangKami">
    ...
    <!-- section galery -->
    <div class="p-5 mt-28 mb-10 bg-surface-700" id="galeri">
    ...
    <!-- section contact us -->
    <div class="m-5 mt-28 mb-28" id="hubungiKami">
        <div class="flex justify-between m-5">
            <div>
